...
2. **Working on a prototype or any project that does not have its own
   ...
   - Naming & sizing spec (Markdown): ${STORAGE_BASE}/iconology.md
   - Visual browser:    /iconology/library
...
// Mirror the committed reference markdown into public/tokens/ as a back-compat
...
// so the design-system.arcsite.com/tokens/*.md paths still resolve. iconology.md
// is the icon naming/sizing spec — same MD-canonical pipeline as the token docs.
const TOKEN_DOCS = ["tokens-color.md", "tokens-typography.md", "tokens-size-space.md", "iconology.md"];
