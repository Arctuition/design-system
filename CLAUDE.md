...
> - **Editing via the CMS is enough and instant** — Save (writes KV) + "Publish to Production" (mirrors KV → Storage) reaches AI agents and prototypes within seconds, no rebuild / PR / repo edit.
