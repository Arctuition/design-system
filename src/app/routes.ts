    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "cms/color-editor/article", lazy: lazyComponent(() => import("./pages/cms/ColorArticleEditor"), "ColorArticleEditor") },
          { path: "cms/size-editor", lazy: lazyComponent(() => import("./pages/cms/SizeTokensEditor"), "SizeTokensEditor") },
          { path: "cms/size-editor/article", lazy: lazyComponent(() => import("./pages/cms/SizeArticleEditor"), "SizeArticleEditor") },
